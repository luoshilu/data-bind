...
function defineReactive(obj, key, val) {
    ...
    function dependArray(val) {
        for (var e = void 0, i = 0, l = val.length; i < l; i++) {
            e = val[i];
...
function ele(tag, child) {
    var element = lodash.isString(tag) ? document.createElement(tag) : lodash.isElement(tag) ? tag : document.body;
    if (lodash.isString(child) && child) {
        element.appendChild(document.createTextNode(child));
    }
    if (lodash.isElement(child)) {
...
function reader() {
    ele(document.body, [
        ...
        ele('div', [
            ...
            ele('p', "CHUNK " + vm.num + " AND JSON Stringify: " + JSON.stringify(lodash.chunk(vm.chunkArg, vm.num))),
            ele('div', [
                ele('h3', "INFO"),
